...
/// Confirmation dialog for leave approve/reject actions with a remarks text field.
/// Returns a map with 'confirmed' (bool) and 'remarks' (String), or null if dismissed.
Future<Map<String, dynamic>?> showLeaveConfirmationDialog(String empName, bool isApprove) async {
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(color: appTheme.appColor.withOpacity(0.3)),
                ),
